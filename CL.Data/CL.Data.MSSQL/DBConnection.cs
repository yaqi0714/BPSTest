...
{
    public class DBConnection : CL.Data.Interface.IDBConnection
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">CL.Data.Model.DBConnection实体类</param>
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<CL.Data.Model.DBConnection> DataReaderToList(SqlDataReader dataReader)
        {
            List<CL.Data.Model.DBConnection> List = new List<CL.Data.Model.DBConnection>();
            CL.Data.Model.DBConnection model = null;
            while (dataReader.Read())
            {
                model = new CL.Data.Model.DBConnection();
        ...
        /// 查询所有记录
        /// </summary>
        public List<CL.Data.Model.DBConnection> GetAll()
        {
            string sql = "SELECT * FROM DBConnection";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<CL.Data.Model.DBConnection> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
