...
{
    public class Dictionary : CL.Data.Interface.IDictionary
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">CL.Data.Model.Dictionary实体类</param>
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<CL.Data.Model.Dictionary> DataReaderToList(SqlDataReader dataReader)
        {
            List<CL.Data.Model.Dictionary> List = new List<CL.Data.Model.Dictionary>();
            CL.Data.Model.Dictionary model = null;
            while (dataReader.Read())
            {
                model = new CL.Data.Model.Dictionary();
        ...
        /// 查询所有记录
        /// </summary>
        public List<CL.Data.Model.Dictionary> GetAll()
        {
            string sql = "SELECT * FROM Dictionary";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<CL.Data.Model.Dictionary> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public CL.Data.Model.Dictionary Get(Guid id)
        {
        ...
        /// 查询下级记录
        /// </summary>
        public List<CL.Data.Model.Dictionary> GetChilds(Guid id)
        {
        ...
        /// 查询下级记录
        /// </summary>
        public List<CL.Data.Model.Dictionary> GetChilds(string code)
        {
        ...
        /// 根据代码查询一条记录
        /// </summary>
        public CL.Data.Model.Dictionary GetByCode(string code)
        {
