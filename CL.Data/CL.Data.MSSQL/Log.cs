...
{
    public class Log : CL.Data.Interface.ILog
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">CL.Data.Model.Log实体类</param>
        /// <returns>操作所影响的行数</returns>
        public int Add(CL.Data.Model.Log model)
        {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<CL.Data.Model.Log> DataReaderToList(SqlDataReader dataReader)
        {
            List<CL.Data.Model.Log> List = new List<CL.Data.Model.Log>();
            CL.Data.Model.Log model = null;
            while (dataReader.Read())
            {
                model = new CL.Data.Model.Log();
        ...
        public List<CL.Data.Model.Log> GetAll()
        {
            ...
            List<CL.Data.Model.Log> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
