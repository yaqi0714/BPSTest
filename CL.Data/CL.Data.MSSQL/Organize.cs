...
namespace CL.Data.MSSQL
{
    public class Organize : CL.Data.Interface.IOrganize
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">CL.Data.Model.Organize实体类</param>
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<CL.Data.Model.Organize> DataReaderToList(SqlDataReader dataReader)
        {
            List<CL.Data.Model.Organize> List = new List<CL.Data.Model.Organize>();
            CL.Data.Model.Organize model = null;
            while (dataReader.Read())
            {
                model = new CL.Data.Model.Organize();
        ...
        public List<CL.Data.Model.Organize> GetAll()
        {
            ...
            List<CL.Data.Model.Organize> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        {
            string sql = "SELECT * FROM Organize WHERE ID IN(" + CL.Utility.Tools.GetSqlInString(number) + ") ORDER BY Depth";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<CL.Data.Model.Organize> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        ...
        /// <returns></returns>
        public List<CL.Data.Model.Organize> GetAllChild(string number)
        {
