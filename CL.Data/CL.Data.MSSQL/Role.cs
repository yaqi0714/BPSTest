...
{
    public class Role : CL.Data.Interface.IRole
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">CL.Data.Model.Role实体类</param>
        /// <returns>操作所影响的行数</returns>
        public int Add(CL.Data.Model.Role model)
        {
        ...
        /// </summary>
        /// <param name="model">CL.Data.Model.Role实体类</param>
        public int Update(CL.Data.Model.Role model)
        {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<CL.Data.Model.Role> DataReaderToList(SqlDataReader dataReader)
        {
            List<CL.Data.Model.Role> List = new List<CL.Data.Model.Role>();
            CL.Data.Model.Role model = null;
            while (dataReader.Read())
            {
                model = new CL.Data.Model.Role();
        ...
        /// 查询所有记录
        /// </summary>
        public List<CL.Data.Model.Role> GetAll()
        {
            string sql = "SELECT * FROM Role";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<CL.Data.Model.Role> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public CL.Data.Model.Role Get(Guid id)
        {
