...
{
    public class RoleApp : CL.Data.Interface.IRoleApp
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">CL.Data.Model.RoleApp实体类</param>
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<CL.Data.Model.RoleApp> DataReaderToList(SqlDataReader dataReader)
        {
            List<CL.Data.Model.RoleApp> List = new List<CL.Data.Model.RoleApp>();
            CL.Data.Model.RoleApp model = null;
            while (dataReader.Read())
            {
                model = new CL.Data.Model.RoleApp();
        ...
        public List<CL.Data.Model.RoleApp> GetAll()
        {
            ...
            List<CL.Data.Model.RoleApp> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
