...
{
    public class Users : CL.Data.Interface.IUsers
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">CL.Data.Model.Users实体类</param>
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<CL.Data.Model.Users> DataReaderToList(SqlDataReader dataReader)
        {
            List<CL.Data.Model.Users> List = new List<CL.Data.Model.Users>();
            CL.Data.Model.Users model = null;
            while (dataReader.Read())
            {
                model = new CL.Data.Model.Users();
        ...
        public List<CL.Data.Model.Users> GetAll()
        {
            ...
            List<CL.Data.Model.Users> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        public List<Model.Users> GetAllByOrganizeIDArray(Guid[] organizeIDArray)
        {
            ...
            string sql = "SELECT * FROM Users WHERE ID in(SELECT UserID FROM UsersRelation WHERE OrganizeID in(" + CL.Utility.Tools.GetSqlInString(organizeIDArray) + ")) ORDER BY Sort";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<CL.Data.Model.Users> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
