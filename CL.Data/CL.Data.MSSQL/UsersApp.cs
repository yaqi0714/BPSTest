...
{
    public class UsersApp : CL.Data.Interface.IUsersApp
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">CL.Data.Model.UsersApp实体类</param>
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<CL.Data.Model.UsersApp> DataReaderToList(SqlDataReader dataReader)
        {
            List<CL.Data.Model.UsersApp> List = new List<CL.Data.Model.UsersApp>();
            CL.Data.Model.UsersApp model = null;
            while (dataReader.Read())
            {
                model = new CL.Data.Model.UsersApp();
        ...
        public List<CL.Data.Model.UsersApp> GetAll()
        {
            ...
            List<CL.Data.Model.UsersApp> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 查询下级记录
        /// </summary>
        public List<CL.Data.Model.UsersApp> GetChild(Guid id)
        {
