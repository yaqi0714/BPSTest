...
{
    public class UsersInfo : CL.Data.Interface.IUsersInfo
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">CL.Data.Model.UsersInfo实体类</param>
        /// <returns>操作所影响的行数</returns>
        public int Add(CL.Data.Model.UsersInfo model)
        {
        ...
        /// </summary>
        /// <param name="model">CL.Data.Model.UsersInfo实体类</param>
        public int Update(CL.Data.Model.UsersInfo model)
        {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<CL.Data.Model.UsersInfo> DataReaderToList(SqlDataReader dataReader)
        {
            List<CL.Data.Model.UsersInfo> List = new List<CL.Data.Model.UsersInfo>();
            CL.Data.Model.UsersInfo model = null;
            while (dataReader.Read())
            {
                model = new CL.Data.Model.UsersInfo();
        ...
        /// 查询所有记录
        /// </summary>
        public List<CL.Data.Model.UsersInfo> GetAll()
        {
            string sql = "SELECT * FROM UsersInfo";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<CL.Data.Model.UsersInfo> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public CL.Data.Model.UsersInfo Get(Guid userid)
        {
