...
{
    public class UsersRelation : CL.Data.Interface.IUsersRelation
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">CL.Data.Model.UsersRelation实体类</param>
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<CL.Data.Model.UsersRelation> DataReaderToList(SqlDataReader dataReader)
        {
            List<CL.Data.Model.UsersRelation> List = new List<CL.Data.Model.UsersRelation>();
            CL.Data.Model.UsersRelation model = null;
            while (dataReader.Read())
            {
                model = new CL.Data.Model.UsersRelation();
        ...
        public List<CL.Data.Model.UsersRelation> GetAll()
        {
            ...
            List<CL.Data.Model.UsersRelation> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
