...
{
    public class UsersRole : CL.Data.Interface.IUsersRole
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">CL.Data.Model.UsersRole实体类</param>
        /// <returns>操作所影响的行数</returns>
        public int Add(CL.Data.Model.UsersRole model)
        {
        ...
        /// </summary>
        /// <param name="model">CL.Data.Model.UsersRole实体类</param>
        public int Update(CL.Data.Model.UsersRole model)
        {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<CL.Data.Model.UsersRole> DataReaderToList(SqlDataReader dataReader)
        {
            List<CL.Data.Model.UsersRole> List = new List<CL.Data.Model.UsersRole>();
            CL.Data.Model.UsersRole model = null;
            while (dataReader.Read())
            {
                model = new CL.Data.Model.UsersRole();
        ...
        /// 查询所有记录
        /// </summary>
        public List<CL.Data.Model.UsersRole> GetAll()
        {
            string sql = "SELECT * FROM UsersRole";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<CL.Data.Model.UsersRole> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public CL.Data.Model.UsersRole Get(Guid memberid, Guid roleid)
        {
        ...
        /// 根据一组机构ID查询记录
        /// </summary>
        public List<CL.Data.Model.UsersRole> GetByUserIDArray(Guid[] userIDArray)
        {
            string sql = "SELECT * FROM UsersRole WHERE MemberID IN(" + CL.Utility.Tools.GetSqlInString(userIDArray) + ")";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<CL.Data.Model.UsersRole> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        ...
        /// 根据人员ID查询记录
        /// </summary>
        public List<CL.Data.Model.UsersRole> GetByUserID(Guid userID)
        {
