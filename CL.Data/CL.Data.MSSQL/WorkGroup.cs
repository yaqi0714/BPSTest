...
{
    public class WorkGroup : CL.Data.Interface.IWorkGroup
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">CL.Data.Model.WorkGroup实体类</param>
        /// <returns>操作所影响的行数</returns>
        public int Add(CL.Data.Model.WorkGroup model)
        {
        ...
        /// </summary>
        /// <param name="model">CL.Data.Model.WorkGroup实体类</param>
        public int Update(CL.Data.Model.WorkGroup model)
        {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<CL.Data.Model.WorkGroup> DataReaderToList(SqlDataReader dataReader)
        {
            List<CL.Data.Model.WorkGroup> List = new List<CL.Data.Model.WorkGroup>();
            CL.Data.Model.WorkGroup model = null;
            while (dataReader.Read())
            {
                model = new CL.Data.Model.WorkGroup();
        ...
        /// 查询所有记录
        /// </summary>
        public List<CL.Data.Model.WorkGroup> GetAll()
        {
            string sql = "SELECT * FROM WorkGroup";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<CL.Data.Model.WorkGroup> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public CL.Data.Model.WorkGroup Get(Guid id)
        {
