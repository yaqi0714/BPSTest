...
namespace CL.Platform
{
    ...
    {
        private string cacheKey = CL.Utility.Keys.CacheKeys.AppLibrary.ToString();
        private CL.Data.Interface.IAppLibrary dataAppLibrary;
        public AppLibrary()
        {
        ...
        /// 新增
        /// </summary>
        public int Add(CL.Data.Model.AppLibrary model)
        {
        ...
        /// 更新
        /// </summary>
        public int Update(CL.Data.Model.AppLibrary model)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<CL.Data.Model.AppLibrary> GetAll(bool fromCache=false)
        {
            if (!fromCache)
            {
            ...
            else
            {
                ...
                if (obj != null)
                {
                    return obj as List<CL.Data.Model.AppLibrary>;
                }
                else
                {
        ...
        /// 查询单条记录
        /// </summary>
        public CL.Data.Model.AppLibrary Get(Guid id, bool fromCache=false)
        {
            if (!fromCache)
            {
        ...
        {
            CL.Cache.IO.Opation.Remove(cacheKey);
        }
        /// <summary>
        /// 删除
        /// </summary>
        ...
        /// <returns></returns>
        public List<CL.Data.Model.AppLibrary> GetPagerData(out string pager, string query = "", string title = "", string type = "", string address = "")
        {
            return dataAppLibrary.GetPagerData(out pager, query, "Type,Title", CL.Utility.Tools.GetPageSize(),
                CL.Utility.Tools.GetPageNumber(), title, type, address);
        }
        /// <summary>
        /// 查询一个类别下所有记录
        /// </summary>
        public List<CL.Data.Model.AppLibrary> GetAllByType(Guid type)
        {
            if (type.IsEmptyGuid())
            {
                return new List<CL.Data.Model.AppLibrary>();
            }
        ...
        /// 根据代码查询一条记录
        /// </summary>
        public CL.Data.Model.AppLibrary GetByCode(string code)
        {
        ...
        /// <returns></returns>
        public string GetFlowRunAddress(CL.Data.Model.AppLibrary app, string query="")
        {
        ...
        {
            string key = CL.Utility.Keys.CacheKeys.AppLibraryUseMember.ToString();
            var obj = CL.Cache.IO.Opation.Get(key);
