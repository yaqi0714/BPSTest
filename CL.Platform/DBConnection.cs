...
namespace CL.Platform
{
    ...
    {
        private CL.Data.Interface.IDBConnection dataDBConnection;
        public DBConnection()
        {
        ...
        /// 新增
        /// </summary>
        public int Add(CL.Data.Model.DBConnection model)
        {
        ...
        /// 更新
        /// </summary>
        public int Update(CL.Data.Model.DBConnection model)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<CL.Data.Model.DBConnection> GetAll(bool fromCache=false)
        {
            if (!fromCache)
            {
            ...
            {
                string key = CL.Utility.Keys.CacheKeys.DBConnnections.ToString();
                object obj = CL.Cache.IO.Opation.Get(key);
                if (obj != null && obj is List<CL.Data.Model.DBConnection>)
                {
                    return obj as List<CL.Data.Model.DBConnection>;
                }
                else
                {
                    var list = dataDBConnection.GetAll();
                    CL.Cache.IO.Opation.Set(key, list);
                    return list;
                }
            }
        }
        ...
        /// 查询单条记录
        /// </summary>
        public CL.Data.Model.DBConnection Get(Guid id)
        {
        ...
        {
            string key = CL.Utility.Keys.CacheKeys.DBConnnections.ToString();
            CL.Cache.IO.Opation.Remove(key);
        }
        ...
        /// <returns></returns>
        private string test_SqlServer(CL.Data.Model.DBConnection conn)
        {
        ...
        /// <param name="conn"></param>
        /// <returns></returns>
        private string test_Oracle(CL.Data.Model.DBConnection conn)
        {
            return "";
        }
        ...
        /// <returns></returns>
        private string testSql_SqlServer(CL.Data.Model.DBConnection conn, string sql)
        {
            using (SqlConnection sqlConn = new SqlConnection(conn.ConnectionString))
            {
                try
        ...
        /// <param name="where"></param>
        /// <returns></returns>
        private string testSql_Oracle(CL.Data.Model.DBConnection conn, string sql)
        {
            return "";
        }
        ...
        /// <param name="conn"></param>
        /// <returns></returns>
        private List<string> getTables_SqlServer(CL.Data.Model.DBConnection conn)
        {
            using (SqlConnection sqlConn = new SqlConnection(conn.ConnectionString))
            {
                try
        ...
        /// <param name="conn"></param>
        /// <returns></returns>
        private List<string> getTables_Oracle(CL.Data.Model.DBConnection conn)
        {
            return new List<string>();
        }
        ...
        /// <returns></returns>
        private Dictionary<string, string> getFields_SqlServer(CL.Data.Model.DBConnection conn, string table)
        {
            using (SqlConnection sqlConn = new SqlConnection(conn.ConnectionString))
            {
                try
...
WHERE object_id('{0}')=a.id ORDER BY a.colid", table);
        ...
        /// <param name="table"></param>
        /// <returns></returns>
        private Dictionary<string, string> getFields_Oracle(CL.Data.Model.DBConnection conn, string table)
        {
            return new Dictionary<string, string>();
        }
        ...
        /// <returns></returns>
        private string getFieldValue_SqlServer(CL.Data.Model.DBConnection conn, string table, string field, Dictionary<string, string> pkFieldValue)
        {
            using (SqlConnection sqlConn = new SqlConnection(conn.ConnectionString))
            {
                try
        ...
        /// <param name="pkFieldValue">主键和值字典</param>
        /// <returns></returns>
        private string getFieldValue_Oracle(CL.Data.Model.DBConnection conn, string table, string field, Dictionary<string, string> pkFieldValue)
        {
            return "";
        }
        ...
        /// <returns></returns>
        private string getFieldValue_SqlServer(CL.Data.Model.DBConnection conn, string table, string field, string pkField, string pkFieldValue)
        {
            string v = "";
            using (SqlConnection sqlConn = new SqlConnection(conn.ConnectionString))
            {
        ...
        /// <param name="pkFieldValue">主键值</param>
        /// <returns></returns>
        private string getFieldValue_Oracle(CL.Data.Model.DBConnection conn, string table, string field, string pkField, string pkFieldValue)
        {
            return "";
        }
        ...
        /// <returns></returns>
        public System.Data.IDbConnection GetConnection(CL.Data.Model.DBConnection dbconn)
        {
        ...
        /// <returns></returns>
        public bool TestSql(CL.Data.Model.DBConnection dbconn, string sql)
        {
            if (dbconn == null)
            {
                return false;
        ...
        /// <param name="linkID"></param>
        /// <returns></returns>
        public System.Data.DataTable GetDataTable(CL.Data.Model.DBConnection dbconn, string sql)
        {
            if (dbconn == null || dbconn.Type.IsNullOrEmpty() || dbconn.ConnectionString.IsNullOrEmpty())
            {
                return null;
