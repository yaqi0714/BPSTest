...
namespace CL.Platform
{
    ...
    {
        private CL.Data.Interface.IDictionary dataDictionary;
        private static string cacheKey = CL.Utility.Keys.CacheKeys.Dictionary.ToString();
        public Dictionary()
        {
        ...
        /// 新增
        /// </summary>
        public int Add(CL.Data.Model.Dictionary model)
        {
        ...
        /// 更新
        /// </summary>
        public int Update(CL.Data.Model.Dictionary model)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<CL.Data.Model.Dictionary> GetAll(bool fromCache=false)
        {
            if (!fromCache)
            {
            ...
            {
                object obj = CL.Cache.IO.Opation.Get(cacheKey);
                if (obj != null && obj is List<CL.Data.Model.Dictionary>)
                {
                    return obj as List<CL.Data.Model.Dictionary>;
                }
                else
                {
                    var list = dataDictionary.GetAll();
                    CL.Cache.IO.Opation.Set(cacheKey, list);
                    return list;
                }
            }
        }
        ...
        /// 查询单条记录
        /// </summary>
        public CL.Data.Model.Dictionary Get(Guid id, bool fromCache = false)
        {
        ...
        /// 查询根记录
        /// </summary>
        public CL.Data.Model.Dictionary GetRoot()
        {
        ...
        /// 查询下级记录
        /// </summary>
        public List<CL.Data.Model.Dictionary> GetChilds(Guid id, bool fromCache=false)
        {
        ...
        /// 查询下级记录
        /// </summary>
        public List<CL.Data.Model.Dictionary> GetChilds(string code, bool fromCache=false)
        {
            return code.IsNullOrEmpty() ? new List<CL.Data.Model.Dictionary>() :
                fromCache ? getChildsByCodeFromCache(code) :
                dataDictionary.GetChilds(code.Trim());
        }

        private List<CL.Data.Model.Dictionary> getChildsByCodeFromCache(string code)
        {
            var list = GetAll(true);
            var dict = list.Find(p => string.Compare(p.Code, code, true) == 0);
            return dict == null ? new List<CL.Data.Model.Dictionary>() : list.FindAll(p => p.ParentID == dict.ID).OrderBy(p=>p.Sort).ToList();
        }

        private List<CL.Data.Model.Dictionary> getChildsByIDFromCache(Guid id)
        {
            var list = GetAll(true);
        ...
        /// <returns></returns>
        public List<CL.Data.Model.Dictionary> GetAllChilds(string code, bool fromCache)
        {
            if (code.IsNullOrEmpty()) return new List<CL.Data.Model.Dictionary>();
            var dict = GetByCode(code, fromCache);
            if (dict == null) return new List<CL.Data.Model.Dictionary>();
        ...
        /// <param name="fromCache">是否使用缓存</param>
        /// <returns></returns>
        public List<CL.Data.Model.Dictionary> GetAllChilds(Guid id, bool fromCache=false)
        {
            List<CL.Data.Model.Dictionary> list = new List<CL.Data.Model.Dictionary>();
            addChilds(list, id, fromCache);
            return list;
        }

        private void addChilds(List<CL.Data.Model.Dictionary> list, Guid id, bool fromCache=false)
        {
        ...
        /// 查询上级记录
        /// </summary>
        public CL.Data.Model.Dictionary GetParent(Guid id)
        {
        ...
        /// <param name="fromCache">是否使用缓存</param>
        /// <returns></returns>
        public CL.Data.Model.Dictionary GetByCode(string code, bool fromCache=false)
        {
        ...
        /// <returns></returns>
        private int getParentCount(List<CL.Data.Model.Dictionary> dictList, CL.Data.Model.Dictionary dict)
        {
            int parent = 0;
            CL.Data.Model.Dictionary parentDict = dictList.Find(p => p.ID == dict.ParentID);
        ...
        private string getRadios(List<CL.Data.Model.Dictionary> childs, string name, OptionValueField valueField = OptionValueField.Value, string value = "", string attr = "")
        {
            StringBuilder options = new StringBuilder(childs.Count * 100);
            foreach (var child in childs)
            {
        ...
        private string getCheckboxs(List<CL.Data.Model.Dictionary> childs, string name, OptionValueField valueField = OptionValueField.Value, string value = "", string attr = "")
        {
            StringBuilder options = new StringBuilder(childs.Count * 100);
            foreach (var child in childs)
            {
        ...
        private string getOptionsValue(OptionValueField valueField, CL.Data.Model.Dictionary dict)
        {
        ...
        {
            CL.Cache.IO.Opation.Set(cacheKey, GetAll());
        }
