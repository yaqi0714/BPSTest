...
namespace CL.Platform
{
    public class Log
    {
        private CL.Data.Interface.ILog dataLog;
        private static CL.Data.Interface.ILog dataLog1 = Data.Factory.Factory.GetLog();
        private delegate void dgWriteLog(CL.Data.Model.Log log);
        public Log()
        {
        ...
        /// 更新
        /// </summary>
        public int Update(CL.Data.Model.Log model)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<CL.Data.Model.Log> GetAll()
        {
        ...
        /// 查询单条记录
        /// </summary>
        public CL.Data.Model.Log Get(Guid id)
        {
        ...
        /// 新增
        /// </summary>
        private static void add(CL.Data.Model.Log model)
        {
            dataLog1.Add(model);
        }
        ...
        /// 新增
        /// </summary>
        public static void Add(CL.Data.Model.Log model)
        {
        ...
        public static void Add(string title, string contents, Types type = Types.其它分类, string oldXML = "", string newXML = "", CL.Data.Model.Users user = null)
        {
            if (user == null)
            {
                user = Platform.Users.CurrentUser;
            }
            CL.Data.Model.Log log = new CL.Data.Model.Log();
            log.Contents = contents;
            log.ID = Guid.NewGuid();
            log.IPAddress = CL.Utility.Tools.GetIPAddress();
            log.Others = string.Format("操作系统：{0} 浏览器：{1}", CL.Utility.Tools.GetOSName(), CL.Utility.Tools.GetBrowse());
            log.Title = title;
            ...
            log.WriteTime = CL.Utility.DateTimeNew.Now;
            Add(log);
        }
        ...
        {
            return dataLog.GetPagerData(out pager, query, CL.Utility.Tools.GetPageSize(), CL.Utility.Tools.GetPageNumber(),
