...
namespace CL.Platform
{
    ...
    {
        private CL.Data.Interface.IRoleApp dataRoleApp;
        public RoleApp()
        {
        ...
        /// 新增
        /// </summary>
        public int Add(CL.Data.Model.RoleApp model)
        {
        ...
        /// 更新
        /// </summary>
        public int Update(CL.Data.Model.RoleApp model)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<CL.Data.Model.RoleApp> GetAll()
        {
        ...
        /// 查询单条记录
        /// </summary>
        public CL.Data.Model.RoleApp Get(Guid id)
        {
        ...
        /// 查询一个角色所有记录
        /// </summary>
        public List<CL.Data.Model.RoleApp> GetAllByRoleID(Guid roleID)
        {
        ...
        /// 查询下级记录
        /// </summary>
        public List<CL.Data.Model.RoleApp> GetChild(Guid id)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public List<CL.Data.Model.RoleApp> GetAllChild(Guid id)
        {
            List<CL.Data.Model.RoleApp> list = new List<CL.Data.Model.RoleApp>();
        ...
        private void addChilds(List<CL.Data.Model.RoleApp> list, Guid id)
        {
            var childs = GetChild(id);
            foreach (var child in childs)
            {
        ...
        {
            RoleApp RoleApp = new CL.Platform.RoleApp();
        ...
        private void insertChilds(Guid oldID, Guid newID, Guid roleID, List<CL.Data.Model.RoleApp> apps)
        {
        ...
        /// <param name="roleID"></param>
        /// <returns></returns>
        public CL.Data.Model.RoleApp GetRootByRoleID(Guid roleID)
        {
