...
namespace CL.Platform
{
    public class Users
    {
        ...
        private CL.Data.Interface.IUsers dataUsers;
        public Users()
        {
        ...
        /// 新增
        /// </summary>
        public int Add(CL.Data.Model.Users model)
        {
        ...
        /// 更新
        /// </summary>
        public int Update(CL.Data.Model.Users model)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<CL.Data.Model.Users> GetAll()
        {
        ...
        /// 查询单条记录
        /// </summary>
        public CL.Data.Model.Users Get(Guid id)
        {
        ...
        /// 根据帐号查询一条记录
        /// </summary>
        public CL.Data.Model.Users GetByAccount(string account)
        {
        ...
        {
            return CL.Utility.Config.SystemInitPassword;
        }
        /// <summary>
        /// 得到加密后的密码字符串
        /// </summary>
        ...
        public string EncryptionPassword(string password)
        {
            ...
            CL.Utility.HashEncrypt hash = new CL.Utility.HashEncrypt();
        ...
        /// <returns></returns>
        public List<CL.Data.Model.Users> GetAllByOrganizeID(Guid organizeID)
        {
        ...
        /// <param name="organizeID"></param>
        /// <returns></returns>
        public List<CL.Data.Model.Users> GetAllByOrganizeIDArray(Guid[] organizeIDArray)
        {
        ...
        /// <param name="userID"></param>
        /// <returns></returns>
        public CL.Data.Model.Organize GetDeptByUserID(Guid userID)
        { 
            ...
            var parents = new CL.Platform.Organize().GetAllParent(stationID);
            parents.Reverse();
        ...
        public static Guid CurrentUserID
        {
            get
            {
                object session = System.Web.HttpContext.Current.Session[CL.Utility.Keys.SessionKeys.UserID.ToString()];
        ...
        /// 得到当前登录用户
        /// </summary>
        public static CL.Data.Model.Users CurrentUser
        {
            get
            {
                object obj = System.Web.HttpContext.Current.Session[CL.Utility.Keys.SessionKeys.User.ToString()];
                if (obj == null)
                {
                    ...
                    else
                    {
                        ...
                        if (user != null)
                        {
                            System.Web.HttpContext.Current.Session[CL.Utility.Keys.SessionKeys.User.ToString()] = user;
                        }
                        return user;
                    }
                }
                ...
                {
                    return obj as CL.Data.Model.Users;
                }
            }
        }
        ...
        public string GetLeader(Guid userID)
        {
            ...
            CL.Platform.Organize borg = new Organize();
    ...
    public class UsersEqualityComparer : IEqualityComparer<CL.Data.Model.Users>
    {
        public bool Equals(CL.Data.Model.Users user1, CL.Data.Model.Users user2)
        {
            return user1 == null || user2 == null || user1.ID == user2.ID;
        }
        public int GetHashCode(CL.Data.Model.Users user)
        {
