...
namespace CL.Platform
{
    ...
    {
        private CL.Data.Interface.IUsersApp dataUsersApp;
        public UsersApp()
        {
        ...
        /// 新增
        /// </summary>
        public int Add(CL.Data.Model.UsersApp model)
        {
        ...
        /// 更新
        /// </summary>
        public int Update(CL.Data.Model.UsersApp model)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<CL.Data.Model.UsersApp> GetAll()
        {
        ...
        /// 查询单条记录
        /// </summary>
        public CL.Data.Model.UsersApp Get(Guid id)
        {
        ...
        {
            string cacheKey = CL.Utility.Keys.CacheKeys.UsersApp.ToString();
            if (fromCache)
            {
                ...
                if (obj == null || !(obj is System.Data.DataTable))
                {
                    ...
                    CL.Cache.IO.Opation.Insert(cacheKey, dt);
                    return dt;
                }
                else
                {
        ...
        public void AppendUserApps(Guid userID, Guid parentID, List<CL.Data.Model.RoleApp> appList)
        {
            ...
            foreach (var userApp in userApps)
            {
                ...
                {
                    CL.Data.Model.RoleApp app = new CL.Data.Model.RoleApp();
        ...
        /// 查询下级记录
        /// </summary>
        public List<CL.Data.Model.UsersApp> GetChilds(Guid id)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public List<CL.Data.Model.UsersApp> GetAllChilds(Guid id)
        {
            List<CL.Data.Model.UsersApp> list = new List<CL.Data.Model.UsersApp>();
            addChilds(id, list);
            return list;
        }

        private void addChilds(Guid id, List<CL.Data.Model.UsersApp> list)
        {
