...
namespace CL.Platform
{
    ...
    {
        private static string cacheKey = CL.Utility.Keys.CacheKeys.UserRoles.ToString();
        private CL.Data.Interface.IUsersRole dataUsersRole;
        public UsersRole()
        {
        ...
        /// 查询单条记录
        /// </summary>
        public CL.Data.Model.UsersRole Get(Guid userid, Guid roleid)
        {
        ...
        /// 根据一组用户ID查询记录
        /// </summary>
        public List<CL.Data.Model.UsersRole> GetByUserIDArray(Guid[] memberIDArray)
        {
        ...
        /// 根据用户ID查询记录
        /// </summary>
        public List<CL.Data.Model.UsersRole> GetByUserID(Guid memberID)
        {
        ...
        /// <returns></returns>
        public List<CL.Data.Model.UsersRole> GetByUserIDFromCache(Guid userID)
        {
        ...
        public void UpdateByUserID(Guid userID)
        {
            ...
            foreach (var role in roles)
            {
                ...
                {
                    busersRole.Add(new CL.Data.Model.UsersRole()
                    {
                        IsDefault = true,
                        MemberID = userID,
                        RoleID = role.ID
        ...
        /// </summary>
        /// <returns></returns>
        public List<CL.Data.Model.UsersRole> GetAllFromCache()
        {
            var obj = CL.Cache.IO.Opation.Get(cacheKey);
            if (obj == null || !(obj is List<CL.Data.Model.UsersRole>))
            {
                var list = GetAll();
            ...
            {
                return obj as List<CL.Data.Model.UsersRole>;
            }
        }
