...
namespace CL.Platform
{
    public class WorkGroup
    {
        ...
        private CL.Data.Interface.IWorkGroup dataWorkGroup;
        public WorkGroup()
        {
        ...
        public string GetUsersNames(string members, char split = ',')
        {
            ...
            var users = new CL.Platform.Organize().GetAllUsers(members);
        ...
        /// <param name="split"></param>
        /// <returns></returns>
        public string GetUsersNames(CL.Data.Model.WorkGroup wg, char split = ',')
        {
