...
public static class MyExtensions
{
    ...
    {
        return CL.Utility.Encryption.Encrypt(str);
    }
    /// <summary>
    /// AES解密字符串
    /// </summary>
    ...
    {
        return CL.Utility.Encryption.Decrypt(str);
    }
    ...
    {
        return CL.Utility.EncryptionDes.Encrypt(str);
    }
    /// <summary>
    /// DES解密字符串
    /// </summary>
    ...
    {
        return CL.Utility.EncryptionDes.Decrypt(str);
    }
